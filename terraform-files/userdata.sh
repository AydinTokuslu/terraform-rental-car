...
git clone https://github.com/AydinTokuslu/terraform-rental-car.git
cd /home/ubuntu/terraform-rental-car
chown -R ubuntu:ubuntu /home/ubuntu/terraform-rental-car
chmod -R 755 /home/ubuntu/terraform-rental-car
python3 -m venv venv
